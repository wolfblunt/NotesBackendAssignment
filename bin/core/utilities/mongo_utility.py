...
class MongoUtility():
    ...
    def query_by_condition(self, database_name, collection_name, input_json):
        """
        ...
        try:
            db = self.__mongo_OBJ__[database_name]
            mongo_response = db[collection_name].find(input_json)
    ...
    def find_using_keyword(self, json_data, database_name, collection_name):
        """
        To find single document in collection
        :param json_data:
        :param database_name:
